function parseUplink(device, payload)
{
    ...
    if(parsed.temp != null && e1 != null)
        e1.updateGenericSensorStatus(parsed.temp);
        // Store Generic 2
    var e2 = device.endpoints.byAddress("2");
    if(parsed.hum != null && e2 != null)
        e2.updateGenericSensorStatus(parsed.hum);
        // Store Generic 3
 /*        var e3 = device.endpoints.byAddress("3");
    if(parsed.ppm != null && e3 != null)
         e3.updateTemperatureSensorStatus(parsed.ppm);
         */
           // Store Generic 4
    var e3 = device.endpoints.byAddress("3");
    if(parsed.co2 != null && e3 != null)
        e3.updateGenericSensorStatus(parsed.co2);
