...
function getEndpoints(deviceAddress, endpoints)
{
  ...
  // temperatura, mientras que el segundo es un sensor de dióxido de carbono.
   ...
   var e =endpoints.addEndpoint("1", "Temperature sensor", endpointType.genericSensor);
   var e =endpoints.addEndpoint("2", "Humedad sensor", endpointType.genericSensor);
  //var e = endpoints.addEndpoint("3", "CO2 sensor", endpointType.co2Sensor);
   //var e =endpoints.addEndpoint("3", "CO2 sensor", endpointType.ppmConcentrationSensor, ppmConcentrationSensorSubType.carbonDioxide);
