...
# Parsing + Configuration Script – wxindoor - Rev. A

This **Parsing + Configuration** script is designed for the **wxindoor** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – wxindoor Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **wxindoor** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
